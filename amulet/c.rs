...
extern  {
    ...
    fn addnstr(++arg1: *c_schar, ++arg2: c_int) -> c_int;
    fn addstr(++arg1: *c_schar) -> c_int;
    ...
    fn erase() -> c_int;
    fn endwin() -> c_int;
    fn erasechar() -> c_schar;
    fn filter();
    fn flash() -> c_int;
    fn flushinp() -> c_int;
    fn getbkgd(++arg1: *WINDOW) -> chtype;
    fn getch() -> c_int;
    fn getnstr(++arg1: *c_schar, ++arg2: c_int) -> c_int;
    fn getstr(++arg1: *c_schar) -> c_int;
    ...
    fn innstr(++arg1: *c_schar, ++arg2: c_int) -> c_int;
    fn insch(++arg1: chtype) -> c_int;
    fn insdelln(++arg1: c_int) -> c_int;
    fn insertln() -> c_int;
    fn insnstr(++arg1: *c_schar, ++arg2: c_int) -> c_int;
    fn insstr(++arg1: *c_schar) -> c_int;
    fn instr(++arg1: *c_schar) -> c_int;
    ...
    fn mvaddnstr(++arg1: c_int, ++arg2: c_int, ++arg3: *c_schar, ++arg4: c_int) -> c_int;
    fn mvaddstr(++arg1: c_int, ++arg2: c_int, ++arg3: *c_schar) -> c_int;
    ...
    fn mvgetnstr(++arg1: c_int, ++arg2: c_int, ++arg3: *c_schar, ++arg4: c_int) -> c_int;
    fn mvgetstr(++arg1: c_int, ++arg2: c_int, ++arg3: *c_schar) -> c_int;
    ...
    fn mvinnstr(++arg1: c_int, ++arg2: c_int, ++arg3: *c_schar, ++arg4: c_int) -> c_int;
    fn mvinsch(++arg1: c_int, ++arg2: c_int, ++arg3: chtype) -> c_int;
    fn mvinsnstr(++arg1: c_int, ++arg2: c_int, ++arg3: *c_schar, ++arg4: c_int) -> c_int;
    fn mvinsstr(++arg1: c_int, ++arg2: c_int, ++arg3: *c_schar) -> c_int;
    fn mvinstr(++arg1: c_int, ++arg2: c_int, ++arg3: *c_schar) -> c_int;
    ...
    fn mvwaddnstr(++arg1: *WINDOW, ++arg2: c_int, ++arg3: c_int, ++arg4: *c_schar, ++arg5: c_int) -> c_int;
    fn mvwaddstr(++arg1: *WINDOW, ++arg2: c_int, ++arg3: c_int, ++arg4: *c_schar) -> c_int;
    ...
    fn mvwgetnstr(++arg1: *WINDOW, ++arg2: c_int, ++arg3: c_int, ++arg4: *c_schar, ++arg5: c_int) -> c_int;
    fn mvwgetstr(++arg1: *WINDOW, ++arg2: c_int, ++arg3: c_int, ++arg4: *c_schar) -> c_int;
    ...
    fn mvwinnstr(++arg1: *WINDOW, ++arg2: c_int, ++arg3: c_int, ++arg4: *c_schar, ++arg5: c_int) -> c_int;
    fn mvwinsch(++arg1: *WINDOW, ++arg2: c_int, ++arg3: c_int, ++arg4: chtype) -> c_int;
    fn mvwinsnstr(++arg1: *WINDOW, ++arg2: c_int, ++arg3: c_int, ++arg4: *c_schar, ++arg5: c_int) -> c_int;
    fn mvwinsstr(++arg1: *WINDOW, ++arg2: c_int, ++arg3: c_int, ++arg4: *c_schar) -> c_int;
    fn mvwinstr(++arg1: *WINDOW, ++arg2: c_int, ++arg3: c_int, ++arg4: *c_schar) -> c_int;
    ...
    fn slk_set(++arg1: c_int, ++arg2: *c_schar, ++arg3: c_int) -> c_int;
    fn slk_touch() -> c_int;
    fn standout() -> c_int;
    fn standend() -> c_int;
    ...
    */
    ...
    fn waddnstr(++arg1: *WINDOW, ++arg2: *c_schar, ++arg3: c_int) -> c_int;
    fn waddstr(++arg1: *WINDOW, ++arg2: *c_schar) -> c_int;
    ...
    fn wgetnstr(++arg1: *WINDOW, ++arg2: *c_schar, ++arg3: c_int) -> c_int;
    fn wgetstr(++arg1: *WINDOW, ++arg2: *c_schar) -> c_int;
    ...
    fn winnstr(++arg1: *WINDOW, ++arg2: *c_schar, ++arg3: c_int) -> c_int;
    fn winsch(++arg1: *WINDOW, ++arg2: chtype) -> c_int;
    fn winsdelln(++arg1: *WINDOW, ++arg2: c_int) -> c_int;
    fn winsertln(++arg1: *WINDOW) -> c_int;
    fn winsnstr(++arg1: *WINDOW, ++arg2: *c_schar, ++arg3: c_int) -> c_int;
    fn winsstr(++arg1: *WINDOW, ++arg2: *c_schar) -> c_int;
    fn winstr(++arg1: *WINDOW, ++arg2: *c_schar) -> c_int;
